...
def read_from_file(filename, month=0, day=0):
    result_list = []
    ...
    with open(filename, "r", newline="") as csv_file:
        ...
        for line in csv.DictReader(csv_file):
            # print( line)  # NOTE:  uncomment if you want to know how the line appears after interpreted by the csv module
            if day > 0:
                # print("hej")
                day -= 1
            else:
                ...
                if (
                    month == 0
                    or datetime.date.fromisoformat(line.get("date")).month == month
                ):
